package com.algaworks.algashop.ordering.core.ports.in.customer.query;
...
class CustomerQueryServiceImplIT extends AbstractApplicationIT {
    ...
    public void shouldFindById() {
        ...
        CustomerOutput output = forQueryingCustomers.findById(customer.id().value());
    ...
    public void shouldFilterByPage() {
        ...
        Page<CustomerSummaryOutput> page = forQueryingCustomers.filter(filter);
