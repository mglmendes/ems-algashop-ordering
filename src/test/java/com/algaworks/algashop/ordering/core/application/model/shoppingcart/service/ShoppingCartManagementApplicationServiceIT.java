package com.algaworks.algashop.ordering.core.application.model.shoppingcart.service;
...
import com.algaworks.algashop.ordering.core.domain.model.customer.exception.CustomerAlreadyHaveShoppingCartException;
...
import com.algaworks.algashop.ordering.core.domain.model.product.exception.ProductOutOfStockException;
...
import com.algaworks.algashop.ordering.core.domain.model.shoppingcart.event.ShoppingCartCreatedEvent;
import com.algaworks.algashop.ordering.core.domain.model.shoppingcart.event.ShoppingCartEmptiedEvent;
import com.algaworks.algashop.ordering.core.domain.model.shoppingcart.event.ShoppingCartItemAddedEvent;
import com.algaworks.algashop.ordering.core.domain.model.shoppingcart.event.ShoppingCartItemRemovedEvent;
import com.algaworks.algashop.ordering.core.domain.model.shoppingcart.exception.ShoppingCartDoesNotContainItemException;
...
class ShoppingCartManagementApplicationServiceIT extends AbstractApplicationIT {
    ...
    void shouldCreateNewShoppingCartForExistingCustomer() {
        ...
        UUID newShoppingCartId = forManagingShoppingCarts.createNew(customer.id().value());
    ...
    void shouldThrowCustomerNotFoundExceptionWhenCreatingNewShoppingCartForNonExistingCustomer() {
        ...
        Assertions.assertThatExceptionOfType(CustomerNotFoundException.class)
                .isThrownBy(() -> forManagingShoppingCarts.createNew(nonExistingCustomerId));
    }
    ...
    void shouldThrowShoppingCartNotFoundExceptionWhenAddingItemToNonExistingShoppingCart() {
        ...
        Assertions.assertThatExceptionOfType(ShoppingCartNotFoundException.class)
                .isThrownBy(() -> forManagingShoppingCarts.addItem(input));
    }
    ...
    void shouldRemoveItemFromShoppingCartSuccessfully() {
        ...
        forManagingShoppingCarts.removeItem(shoppingCart.id().value(), itemToRemove.id().value());
    ...
    void shouldThrowShoppingCartNotFoundExceptionWhenRemovingItemFromNonExistingShoppingCart() {
        ...
        Assertions.assertThatExceptionOfType(ShoppingCartNotFoundException.class)
                .isThrownBy(() -> forManagingShoppingCarts.removeItem(nonExistingCartId, dummyItemId));
    }
